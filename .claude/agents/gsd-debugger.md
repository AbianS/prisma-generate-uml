...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude
                  → checks /Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/get-shit-done
                  → writes to /Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/get-shit-done/hooks/
...
@/Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
node "/Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
