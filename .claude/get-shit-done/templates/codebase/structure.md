...
- Usage: Reference from command with `@/Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/abiansuarezbrito/Documents/prisma-generate-uml/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
